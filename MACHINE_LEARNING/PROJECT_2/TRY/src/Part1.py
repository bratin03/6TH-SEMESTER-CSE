...
class NeuralNetwork:
    ...
    def dataLoader(self):
        ...
        self.train_data_feats = self.train_data.iloc[:, :-101].to_numpy()
        self.train_data_labels = self.train_data.iloc[:, -101:].to_numpy()
        self.test_data_feats = self.test_data.iloc[:, :-101].to_numpy()
        self.test_data_labels = self.test_data.iloc[:, -101:].to_numpy()
